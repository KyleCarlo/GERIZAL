      ...
      <div className="mt-8">
          ...
          <div className="flex flex-col basis-1/2 justify-center pr-10 pb-10">
            <ul className="space-y-8 text-justify">
              ...
              <li>
                ...
                , and <span className="italic font-bold">Ateneo de Manila</span>{" "}
                offered formal educaition—mostly to sons of Spanish and mestizo
                families.
              </li>
              <li>
                In provincial areas, education was limited to parish schools run
                by friars. These schools focused mainly on religious
                instruction, especially Catholic catechism.
              </li>
              <li>
                The government had little direct role. Religious orders set the
                tone for how and what students learned.
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="flex flex-row-reverse">
          ...
          <div className="flex flex-col basis-1/2 justify-center pl-10 relative">
            <ul className="space-y-8 text-justify pb-15">
              ...
              <li>
                Education was delivered <strong>in Spanish</strong>, a language
                most native Filipinos didn't speak. No effort was made to teach
                in local <strong>dialects</strong>. Students had to{" "}
                <strong>learn Spanish first</strong> just to understand basic
                lessons.
              </li>
              <li>
          ...
          <ul className="space-y-2 text-justify basis-1/2">
            ...
            <li>
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>
                  Law schools focused strictly on Spanish jurisprudence, without
                  space for reformist or progressive ideas.
                </li>
              </ul>
            </li>
          </ul>
        ...
        <div className="flex justify-center text-center my-7 text-[1.1rem]">
          <p className="max-w-[70%]">
            ...
            <strong>rote memorization over critical thinking</strong>, creating
            educated Filipinos who couldn't challenge the system that controlled
            them.
          </p>
        </div>
        ...
        <div className="flex items-center">
          ...
          <div className="basis-1/2 space-y-8 pr-10">
            ...
            <p className="text-justify">
              Outside a few city schools, the overall system was underdeveloped:
            </p>
            ...
            <p className="text-justify">
              In many places, what passed for a school was just a room inside a
              convent or house. Most Filipinos never received even a{" "}
          ...
          <div className="basis-1/2">
            <div className="flex justify-center">
              <ul className="space-y-8 text-justify pl-10">
                <h2 className="font-bold text-[1.5rem]">Seeds of Resistance</h2>
                <li>
        ...
        <div className="mt-8 space-y-4 flex flex-col items-center">
          <h2 className="font-bold text-[1.5rem] my-6 text-center">
            Summary: Education that Served the Few
          </h2>
          <div className="space-y-4 max-w-[550px] text-justify">
            <p>
              By the end of the 19th century, the Philippine education system
              had:
            </p>
            <ul className="list-disc list-inside">
              <li>
                Prioritized <strong>religion over reason</strong>,
              </li>
              <li>
                Served <strong>colonial interests over Filipino needs</strong>
              </li>
              <li>
                Educated <strong>only a small elite</strong>, and
              </li>
              <li>
                Left the majority with{" "}
                <strong>no real access to learning</strong>
              </li>
            </ul>
            <p>
              This context explains why education became central to the{" "}
              <strong>Filipino reform and revolutionary movements</strong> that
              followed. It wasn't just about reading and writing—it was about
              liberation.
            </p>
          </div>
        </div>
